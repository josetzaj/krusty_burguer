...
namespace krustyburguer {
	...
	/// Resumen de combo5
	/// </summary>
	public ref class combo5 : public System::Windows::Forms::Form
	{
	public:
		combo5(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(combo5::typeid));
			...
			this->cbPostre->Location = System::Drawing::Point(353, 283);
			...
			this->label2->Location = System::Drawing::Point(105, 288);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(242, 16);
			...
			this->label6->Location = System::Drawing::Point(106, 71);
			...
			this->label5->Location = System::Drawing::Point(105, 187);
			...
			this->label4->Location = System::Drawing::Point(228, 29);
			...
			this->cbBebida->Location = System::Drawing::Point(353, 236);
			...
			this->label3->Location = System::Drawing::Point(106, 241);
			...
			this->lblDescripcion->Location = System::Drawing::Point(120, 135);
			...
			this->label1->Location = System::Drawing::Point(106, 114);
			...
			this->button7->Click += gcnew System::EventHandler(this, &combo5::button7_Click);
			// 
			// combo5
			// 
