...
namespace krustyburguer {
	...
	/// Resumen de combo4
	/// </summary>
	public ref class combo4 : public System::Windows::Forms::Form
	{
	public:
		combo4(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(combo4::typeid));
			...
			this->cbPostre->Items->AddRange(gcnew cli::array< System::Object^  >(5) { L"OREO", L"CHICLE", L"CHOCOLATE", L"VAINILLA", L"MENTA" });
			this->cbPostre->Location = System::Drawing::Point(342, 285);
			...
			this->label2->Location = System::Drawing::Point(110, 288);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(220, 16);
			this->label2->TabIndex = 19;
			this->label2->Text = L"SELECCIONA EL SABOR DEL HELADO";
			// 
			// txtCodCombo
			// 
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->ForeColor = System::Drawing::Color::White;
			this->label6->Location = System::Drawing::Point(111, 71);
			...
			this->label5->Location = System::Drawing::Point(110, 187);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->ForeColor = System::Drawing::Color::White;
			this->label4->Location = System::Drawing::Point(233, 29);
			...
			this->cbBebida->Location = System::Drawing::Point(342, 238);
			...
			this->label3->Location = System::Drawing::Point(111, 241);
			...
			this->lblDescripcion->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei UI", 9, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lblDescripcion->Location = System::Drawing::Point(126, 135);
			...
			this->label1->Location = System::Drawing::Point(111, 114);
			...
			this->panel1->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->button7->Click += gcnew System::EventHandler(this, &combo4::button7_Click);
			// 
			// combo4
			// 
